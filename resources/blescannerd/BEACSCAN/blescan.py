...
def parse_events(sock, loop_count=100):
    ...
    for i in range(0, loop_count):
		...
		i =0
		    ...
		    if trame[0:14] in ['0201041bffb602','0201061bffb602']:
				string =''
				string += 'Schneider found '
				if trame[14:18] == '8e44':
					string += 'This is a switch with UUID ' + trame[24:30]
					if trame[30:32] == '02':
						string += ' action is toggle'
				elif trame[14:18] == '9844':
					string += 'This is a DCL with UUID '+ trame[24:30]
					if trame[32:34] == '01':
						string += ' state is ON'
					else:
						string += ' state is OFF'
